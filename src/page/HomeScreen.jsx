  ...
  return (
    <>
      ...
      <div className="content bottom">
        ...
        <h3>&nbsp; &nbsp; จาการสำรวจปัญหาภายในกรุงเทพมหานครนั้นเราได้พบว่าปัญหาทางจราจรเป็นปัญหาที่ยังแก้ไม่หายไปเสียที เราจึงเริ่มจับต้นตอของปัญหาทางจราจรมา จึงได้พบว่าในช่วงฤดูฝนนั้นเกิดเหตุการณ์น้ำท่วม น้ำระบายไม่ทัน สาเหตุมาจากท่ออุดตันไม่สามารถระบายน้ำได้  </h3>
        <br/>
        ...
        <center><h3>พนักงานมากกว่า<div className="counter red">
